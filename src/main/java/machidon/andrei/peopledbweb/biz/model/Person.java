package machidon.andrei.peopledbweb.biz.model;
...
public class Person {
    ...
    @NotNull(message = "The Date of Birth can not be empty!")
    ...
    @DecimalMin(value = "1000.00", message = "Salary must be at least 10000")
